 ...
 * @author SoumenPC
 */
public class User_add_Address extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            street_number1=request.getParameter("street_number1");
            vill_town1=request.getParameter("vill_town1");
            post_office1=request.getParameter("post_office1");
            police_station1=request.getParameter("police_station1");
            s_town=request.getParameter("s_town");
            s_state=request.getParameter("s_state");
            pin_code1=request.getParameter("pin_code1");
            landmark1=request.getParameter("landmark1");
           ...
           int x=db.insetUserAddress(val);
           if(x==1)
            {
            response.sendRedirect("User/Add_Address.jsp?msg=Done");
            }
            else
            {
            response.sendRedirect("User/Add_Address.jsp?msg=error1");
            }
        ...
        {
            response.sendRedirect("User/Add_Address.jsp?msg=error");
        }
    }
