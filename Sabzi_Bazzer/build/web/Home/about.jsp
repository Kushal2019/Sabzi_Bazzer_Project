...
<body>
  ...
  <!-- Navbar start -->
  <%@include file="../PageFiles/navAbout.jsp" %>
  <!-- Navbar end -->
  ...
  <div class="bg-light">
    <div class="container py-3">
      <div class="row h-100 align-items-center py-5">
        ...
        <div class="col-lg-6 d-none d-lg-block"><img src="../image/About_Us/About_1.png" alt="About_1"
            class="img-fluid"></div>
      </div>
    </div>
  </div>
    ...
    <div class="container py-5">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
          ...
          <p class="font-italic text-muted mb-4">Sabzi-Bazzer allows you to walk away from the drudgery of grocery
            shopping and welcome an easy relaxed way of browsing and shopping for groceries.</p><a href="#"
    ...
    <div class="container py-5">
      ...
      <div class="row text-center">
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
          <div class="bg-white rounded shadow-sm py-5 px-4"><img src="../image/Team_Member_Pic/Kushal.jpg" alt="Kushal"
        ...
        <!-- Team item-->
        <div class="col-xl-3 col-sm-6 mb-5">
          <div class="bg-white rounded shadow-sm py-5 px-4"><img src="../image/Team_Member_Pic/Soumen.JPG" alt="Soumen"
              width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <!-- Team item-->
        <div class="col-xl-3 col-sm-6 mb-5">
          <div class="bg-white rounded shadow-sm py-5 px-4"><img src="../image/Team_Member_Pic/Suman.JPG" alt=""
              width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
          <div class="bg-white rounded shadow-sm py-5 px-4"><img
                  src="../image/Team_Member_Pic/Sankho.jpeg" alt="" width="100"
